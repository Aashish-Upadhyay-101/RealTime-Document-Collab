...
const PopoverDemo = ({ children }: any) => (
  <Popover.Root>
      ...
      >
        <div className="flex flex-col gap-2.5">
          ...
          <fieldset className="flex gap-5 items-center">
            <label
              className="text-[13px] text-red-600 w-[75px]"
              htmlFor="width"
            >
              Width
            </label>
            <input
              className="w-full inline-flex items-center justify-center flex-1 rounded px-2.5 text-[13px] leading-none text-violet11 shadow-[0_0_0_1px] shadow-violet7 h-[25px] focus:shadow-[0_0_0_2px] focus:shadow-green-400 outline-none"
              id="width"
              defaultValue="100%"
            />
          </fieldset>
